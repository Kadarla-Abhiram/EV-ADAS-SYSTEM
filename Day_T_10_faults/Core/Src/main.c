...
int main(void)
{
	  ...
	  float seed = (Read_ADC_Channel(ADC_CHANNEL_2) / 4095.0f) * 100.0f;
	  EV_InjectSOC(&ev, seed);                       // expects 0–100 %
	  ...
	  while (1)
	  {
	      /* â”€â”€ EV update every 10ms via TIM1 flag â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
	      if (flag_ev) {
	          flag_ev = 0;
