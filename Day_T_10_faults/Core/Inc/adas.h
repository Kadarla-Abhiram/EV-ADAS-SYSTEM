...
#define ADAS_TTC_WARN_S         2.0f   /* TTC warning threshold      */
#define ADAS_TTC_CRIT_S         1.0f   /* TTC critical threshold     */
#define ADAS_BSD_DIST_CM       30.0f   /* blind spot distance        */
#define ADAS_BSD_SPEED_KMH     10.0f   /* blind spot speed gate      */
